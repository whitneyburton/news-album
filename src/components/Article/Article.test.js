...
describe('Article', () => {
  ...
  it('should match the snapshot', () => {
    ...
    wrapper = shallow(
      <Article article={data.mockNatGeoArticle} match={mockMatch} />
    );
  ...
  describe('getPath', () => {
    ...
    it('should return a crypto coins path', () => {
      ...
      wrapper = shallow(
        <Article article={data.mockCryptoCoinsArticle} match={mockMatch} />
      );
    ...
    it('should return a new scientist path', () => {
      ...
      wrapper = shallow(
        <Article article={data.mockNewScientistArticle} match={mockMatch} />
      );
