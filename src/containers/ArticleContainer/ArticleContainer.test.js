...
describe('ArticleContainer', () => {
  ...
  describe('generateArticleCategory', () => {
    it.skip('should return an array of Article components when there is a NAT GEO path', () => {
      const result = wrapper.instance().generateArticleCategory();
      expect(result).toHaveLength(2);
    });

    it.skip('should return an array of Article components when there is a CRYPTO COINS path', () => {
    ...
    it.skip('should return an array of Article components when there is a NEW SCIENTIST path', () => {
    ...
    it.skip('should return an array of Article components when there is a FAVORITES path', () => {
